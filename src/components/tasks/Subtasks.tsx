...
import { Check, Plus, Trash2, Play, User, Calendar, X, ListChecks } from "lucide-react";
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <ListChecks
            className="w-4 h-4"
            style={{ color: doneCount === subtasks.length && subtasks.length > 0 ? "var(--success)" : "var(--text-3)" }}
          />
      ...
      {/* Subtask cards — always fully expanded */}
      {subtasks.length > 0 && (
          ...
          {subtasks.map((st) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2.5 group px-3 py-2.5">
                  ...
                  {isEditingThisTitle ? (
                    ...
                    <span
                      ...
                      className="flex-1 text-[13px] font-medium min-w-0 truncate"
                      style={{
                ...
                <div className="px-3 pb-3 space-y-2.5 border-t" style={{ borderColor: c.border }}>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {/* Due date */}
                    <div>
                      <label className="text-[10.5px] font-semibold uppercase tracking-wide mb-1 flex items-center gap-1"
                      ...
                      <div className="relative flex items-center">
                        <input
                          ...
                          style={{ background: c.inputBg, color: overdue ? "var(--danger)" : c.text1, border: `1px solid ${overdue ? "var(--danger)" : c.border}` }}
                        />
                        {st.dueDate && (
                          <button type="button" onClick={() => updateField(st, "dueDate", "")}
                          ...
                          {assigneeOpen === st.id && (
                            <>
                              ...
                              <div className="absolute top-full left-0 mt-1 w-48 rounded-xl overflow-hidden z-50"
                                ...
                                {assignee && (
                                  <button onClick={() => updateAssignee(st, null)}
                                ...
                                {members.map((m) => (
                                  <button key={m.id} onClick={() => updateAssignee(st, m.id)}
                                    className="w-full flex items-center gap-2 px-3 py-2 text-[12.5px] transition-colors hover:bg-[var(--hover)]"
